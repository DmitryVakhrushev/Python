...
def draw(c):
    ...
    #if paddle1_pos > 320 and paddle1_vel > 0:
    ...
    # draw paddles    
    # paddle1
    c.draw_line((HALF_PAD_WIDTH, paddle1_pos), (HALF_PAD_WIDTH, paddle1_pos + PAD_HEIGHT), PAD_WIDTH, "Red")
...
#---------------------------------------------------------
    ...
    # check a collision with the LEFT wall
    ...
    # check a collision with the RIGHT wall
